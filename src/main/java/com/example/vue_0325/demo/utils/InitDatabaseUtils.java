 ...
 */
public class InitDatabaseUtils {//定时事务备份数据库相关的类
     ...
     * @return
     */
    public static String getExportCommand(Properties properties) {//连接数据库类(导出数据库的类
        // )
        ...
        //注意哪些地方要空格，哪些不要空格
        //-h  主机名称   -P端口  exportDatabaseName数据库名称     exportPath导出路径
     ...
     * @return
     */
    static String[] getImportCommand(Properties properties) {//导入数据库的类
